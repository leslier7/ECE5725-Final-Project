...
class MotorDriver:
    ...
    def control_from_gravity(self, gravity: Vector3):
        ...
        # dutyCycle 64 - 74: ClockWise
        # dutyCycle 74 - 76: Stop
        # dutyCycle 76 - 86: CounterClockWise
...
def main():
    ...
    while True:
        ...
        motor_control.PWMA.ChangeDutyCycle(temp)
        motor_control.PWMB.ChangeDutyCycle(temp)
